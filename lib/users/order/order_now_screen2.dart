...
class _OrderNowScreen2State extends State<OrderNowScreen2> {
  ...
  void _handlePaymentSuccess(PaymentSuccessResponse response) {
    ...
    Fluttertoast.showToast(msg: "razorpay payment done");
    saveNewOrderInfo();

  }

  void _handlePaymentError(PaymentFailureResponse response) {
    print("razorpay payment error, please try again");
    Fluttertoast.showToast(msg: "razorpay payment error, please try again");
    // Do something when payment fails
  }

  void _handleExternalWallet(ExternalWalletResponse response) {
    // Do something when an external wallet was selected
    print("razorpay payment error1, please try again");
    Fluttertoast.showToast(msg: "razorpay payment error1, please try again");
  }
